...
public class RegisterUserController {
    ...
    @PostMapping
    public ResponseEntity<RegisterUserResponse> registerUserResponse(@Valid @RequestBody RegisterUserCommand command) {
        ...
        try {
            ...
            var safeErrorMessage = "Erro r while processing registered user request for id - " + id;
